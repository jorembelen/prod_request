                    ...
                    <tbody>
                        <template v-if="users">
                            <tr v-for="user in users" :key="user.id">
                                ...
                                <td class="text-center">{{ user.role[0].name }}</td>
                                <td class="text-center">{{ (user.email_verified_at)? 'Active' : 'Not Active'}}</td>
                                <td class="text-right">
                                    <!-- <a href="#" class="btn btn-sm btn-outline-success" @click.prevent="viewProduct(product.id)"><span class="fa fa-eye"></span></a> -->
                                    <a href="#" class="btn btn-sm btn-outline-success" @click.prevent="editUser(user.id)"><span class="fa fa-edit"></span></a>
                                    <a href="#" class="btn btn-sm btn-outline-danger" @click.prevent="removeUser(user.id)"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                        </template>
                        <template v-else>
